...
router.post("/add_Article", (req, res) => {
  const {  code, couleur, S ,XS,M,L,XL,XXL, quantite , like , prix} = req.body;
  const newArticle = new Article({ code, couleur,S ,XS,M,L,XL,XXL, quantite , like , prix }); // create a new document
  newArticle
    .save()
